...
export default function GuestProjectView({ projectRole, ...props }) {
  ...
  const { provider, nodesMap, edgesMap, eventsArray, userName } =
  ...
  const deleteNode = useCallback(
    (nodeId) => {
      if (!nodesMap || !eventsArray || !user) return;
    ...
    [nodesMap, edgesMap, eventsArray, user, projectRole, appendEvent]
  );
